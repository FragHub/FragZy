...
5. Navigate to `bin/Release/net8.0/publish/`and copy all the content from there and paste it into `csgo/addons/counterstrikesharp/plugins/FragBot3` (CounterStrikeSharp.API.dll and CounterStrikeSharp.API.pdb can be skipped)
