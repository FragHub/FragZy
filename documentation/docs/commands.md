...
- `.pause` Pauses the match in freezetime (Tactical or normal pause, depends on `fragbot3_use_pause_command_for_tactical_pause`).
...
- `.whitelist` Toggles whitelisting of players. To whitelist a player, add the steam64id in `cfg/FragBot3/whitelist.cfg`
