...
namespace FragBot3
{
    public partial class FragBot3
    {
        ...
        [ConsoleCommand("fragbot3_remote_log_url", "If defined, all events are sent to this URL over HTTP. If no protocol is provided")]
        ...
        [ConsoleCommand("fragbot3_remote_log_header_key", "If defined, a custom HTTP header with this name is added to the HTTP requests for events")]
        ...
        [ConsoleCommand("fragbot3_remote_log_header_value", "If defined, the value of the custom header added to the events sent over HTTP")]
