    ...
    public partial class FragBot3
    {
        ...
        public void Get5StatusCommand(CCSPlayerController? player, CommandInfo command)
        {
            ...
            if (isMatchSetup)
            {
                ...
                {
                    Name = fragbot3Team1.teamName,
                    SeriesScore = fragbot3Team1.seriesScore,
                    CurrentMapScore = team1,
                    ConnectedClients = -1,
                    Ready = ready,
                    Side = teamSides[fragbot3Team1].ToLower()
                };

                get5Status.Team2 = new Get5StatusTeam
                {
                    Name = fragbot3Team2.teamName,
                    SeriesScore = fragbot3Team2.seriesScore,
                    CurrentMapScore = team2,
                    ConnectedClients = -1,
                    Ready = ready,
                    Side = teamSides[fragbot3Team2].ToLower()
                };
            }
        ...
        {
            // Get state from FragBot3 state phase data and map to get5 state
