...
namespace FragBot3
{
    ...
    public partial class FragBot3
    {
        ...
        [ConsoleCommand("fragbot3_addplayer", "Adds player to the provided team")]
        ...
        public void OnAddPlayerCommand(CCSPlayerController? player, CommandInfo? command)
        {
            ...
            {
                command.ReplyToCommand("Usage: fragbot3_addplayer <steam64> <team> \"<name>\"");
                return; 
            }
            ...
            if (playerTeam == "team1")
            {
                success = AddPlayerToTeam(playerSteamId, playerName, fragbot3Team1.teamPlayers);
            } else if (playerTeam == "team2")
            {
                success = AddPlayerToTeam(playerSteamId, playerName, fragbot3Team2.teamPlayers);
        ...
        [ConsoleCommand("fragbot3_removeplayer", "Removes the player from all the teams")]
        ...
        {
            if (fragbot3Team1.teamPlayers != null && fragbot3Team1.teamPlayers[steamId] != null) return false;
            if (fragbot3Team2.teamPlayers != null && fragbot3Team2.teamPlayers[steamId] != null) return false;
        ...
        {
            List<JToken?> teams = [fragbot3Team1.teamPlayers, fragbot3Team2.teamPlayers, matchConfig.Spectators];
